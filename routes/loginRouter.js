...
router.use((req, res, next)=>{
    switch(req.query.msg){
        ...
        case 'ntFailed': res.locals.msg = 'کد ملی وارد شده با کد ملی ثبت شده مغایرت دارد';
            break;
        case 'usrSame': res.locals.msg = 'نام کاربری و يا کد ملی دیگری انتخاب کنید!';
            break;
        case 'dberr': res.locals.msg = 'مشکلی از سوی دیتابیس';
            break;
        case 'ntErr': res.locals.msg = '!کد ملی شما قبلا در سامانه ثبت شده';
            break;
        default:
            res.locals.msg = ``;
    }
